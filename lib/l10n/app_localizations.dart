...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'kundelik_class_hint': 'Class is set automatically via Kundelik',
      'kundelik_class_connected': 'Class is set automatically',
      ...
      'use_search_to_find_friends': 'Use the search bar to find friends',
      'refresh': 'Refresh',
      // Kundelik
      'kundelik': 'Kundelik',
      'sync_kundelik': 'Sync',
      ...
      'manage_content_desc': 'Delete news and notifications',
      ...
      'kundelik_disconnect_confirm_title': 'Disconnect Kundelik?',
      'kundelik_disconnect_confirm_message': 'GPA and birthday data will be removed from your profile.',
      'kundelik_session_expired': 'Session expired. Please reconnect Kundelik.',
      'friend_request_sent': 'sent you a friend request',
      'birthday_notification_title': 'Birthday!',
      'someone': 'Someone',
      'marks_found': 'marks found',
      'no_marks_found': 'No marks found — GPA unavailable',
      'kundelik_test': 'Test API',
      // Home Screen
      'welcome': 'Welcome',
      ...
      'create_news_desc': 'Post news and announcements for students',
      'create_notification': 'Create Notification',
      'create_notification_desc': 'Send notifications to all users',
      ...
      // Olympiads
      'olympiads_calendar': 'Olympiads Calendar',
      'olympiads_desc': 'View the complete schedule of olympiads and competitions',
      'open_olympiads_calendar': 'Open Calendar',
      'error_opening_link': 'Could not open link',
      // SAT
      'sat_preparation': 'SAT Preparation',
      'sat_subtitle': 'Digital SAT Information & Resources',
      'what_is_sat': 'What is SAT?',
      'sat_description': 'SAT is an international exam required for admission to US universities and some universities in Europe and Asia. It is now fully digital (Digital SAT).\n\nThe exam consists of two sections:\n• Reading & Writing (64 minutes, 54 questions)\n• Math (70 minutes, 44 questions)\n\nTotal duration: approximately 2 hours 14 minutes.',
      'scoring': 'Scoring',
      'sat_scoring': 'Scores range from 400 to 1600:\n• Reading & Writing: 200–800\n• Math: 200–800\n\nGood scores:\n• Competitive: 1450+\n• Top universities: 1500+',
      'test_dates_2025': 'International Test Dates 2025',
      'sat_dates': '• March 8\n• May 3\n• June 7\n• August 23\n• October 4\n• November 8\n• December 6\n\nRegistration closes 3–4 weeks before each test date.',
      'test_centers': 'Test Centers in Almaty',
      'sat_centers': '• Turan University (Туран)\n• Republican Physics and Mathematics School (РФМШ)\n• Miras International School\n• Haileybury Almaty\n• International College of Continuous Education (ICCE)\n• Nazarbayev Intellectual Schools (NIS)',
      'cost': 'Cost',
      'sat_cost': 'Approximately \$103 for international students',
      'official_resources': 'Official Resources',
      'official_sat_website': 'Official SAT Website',
      'register_sat': 'Register for SAT',
      'bluebook_app': 'Bluebook App (Practice Tests)',
      'khan_academy': 'Khan Academy (Free Prep)',
      'preparation_tips': 'Preparation Tips',
      'sat_tip_1': '1. Start at least 2–3 months in advance. Consistency matters more than hours.',
      'sat_tip_2': '2. Take official practice tests in Bluebook. They\'re most similar to the real exam.',
      'sat_tip_3': '3. Math: Solve problems on time. Practice using the calculator efficiently.',
      'sat_tip_4': '4. Reading & Writing: Read 10–20 minutes daily (The Economist, NYT, Scientific American).',
      'sat_tip_5': '5. Review mistakes after each test. Don\'t just "solve" — analyze where logic breaks.',
      'sat_tip_6': '6. Learn new words, but only high-frequency ones. Don\'t waste time on rare vocabulary.',
      'sat_tip_7': '7. During the exam, don\'t linger on one question. SAT is adaptive: keep the pace.',
      'sat_tip_8': '8. 5–7 days before exam, reduce workload. Take 1 final test and rest.',
      'sat_tip_9': '9. On exam day, arrive early and charge your device. Digital SAT runs entirely on laptop.',
      // Calendar & Tasks
      ...
      'overdue': 'Overdue',
      // School Information
      'school_information': 'School Council',
      'no_school_info': 'No school information available',
      'create_school_info': 'Create School Information',
      'category': 'Category',
      'category_all': 'All',
      'category_administration': 'Administration',
      'category_ministry': 'Ministry',
      ...
      'link_title_hint': 'e.g., Google Form',
      'link_url': 'Link URL',
      'add_link': 'Add Link',
      // Admin roles
      ...
      'role_school_government': 'School Council',
    ...
    'ru': {
      ...
      'kundelik_class_hint': 'Класс определяется через Кунделик',
      'kundelik_class_connected': 'Класс определяется автоматически',
      ...
      'recommended_friends': 'Рекомендуемые друзья',
      'use_search_to_find_friends': 'Используйте поиск для поиска друзей',
      'refresh': 'Обновить',
      // Kundelik
      'kundelik': 'Кунделик',
      'sync_kundelik': 'Синхронизировать',
      ...
      'manage_content_desc': 'Удаление новостей и уведомлений',
      ...
      'sync_success': 'Синхронизировано успешно',
      'kundelik_disconnect_confirm_title': 'Отключить Кунделик?',
      'kundelik_disconnect_confirm_message': 'Данные GPA и дата рождения будут удалены из профиля.',
      'kundelik_session_expired': 'Сессия истекла. Переподключите Кунделик.',
      'friend_request_sent': 'отправил(а) вам запрос в друзья',
      'birthday_notification_title': 'День рождения!',
      'someone': 'Кто-то',
      'marks_found': 'оценок найдено',
      'no_marks_found': 'Оценки не найдены — GPA недоступен',
      'kundelik_test': 'Тест API',
      // Home Screen
      ...
      'create_news_desc': 'Публикация новостей и объявлений для учеников',
      'create_notification': 'Создать уведомление',
      'create_notification_desc': 'Отправить уведомления всем пользователям',
      ...
      // Olympiads
      'olympiads_calendar': 'Календарь олимпиад',
      'olympiads_desc': 'Просмотр полного расписания олимпиад и конкурсов',
      'open_olympiads_calendar': 'Открыть календарь',
      'error_opening_link': 'Не удалось открыть ссылку',
      // SAT
      'sat_preparation': 'Подготовка к SAT',
      'sat_subtitle': 'Информация и ресурсы по Digital SAT',
      'what_is_sat': 'Что такое SAT?',
      'sat_description': 'SAT — это международный экзамен, необходимый для поступления в университеты США и некоторые вузы Европы и Азии. Сейчас проходит полностью в цифровом формате (Digital SAT).\n\nЭкзамен состоит из двух частей:\n• Reading & Writing (64 минуты, 54 вопроса)\n• Math (70 минут, 44 вопроса)\n\nОбщая длительность: около 2 часов 14 минут.',
      'scoring': 'Баллы',
      'sat_scoring': 'Баллы от 400 до 1600:\n• Reading & Writing: 200–800\n• Math: 200–800\n\nХорошие результаты:\n• Конкурентные: 1450+\n• Топовые университеты: 1500+',
      'test_dates_2025': 'Международные даты 2025',
      'sat_dates': '• 8 марта\n• 3 мая\n• 7 июня\n• 23 августа\n• 4 октября\n• 8 ноября\n• 6 декабря\n\nРегистрация закрывается за 3–4 недели до экзамена.',
      'test_centers': 'Центры тестирования в Алматы',
      'sat_centers': '• Университет Turan (Туран)\n• Республиканская физико-математическая школа (РФМШ)\n• Международная школа «Мирас»\n• Haileybury Almaty\n• Международный колледж непрерывного образования (ICCE)\n• Назарбаев Интеллектуальные Школы (НИШ)',
      'cost': 'Стоимость',
      'sat_cost': 'Примерно \$103 для международных студентов',
      'official_resources': 'Официальные ресурсы',
      'official_sat_website': 'Официальный сайт SAT',
      'register_sat': 'Регистрация на SAT',
      'bluebook_app': 'Приложение Bluebook (пробные тесты)',
      'khan_academy': 'Khan Academy (бесплатная подготовка)',
      'preparation_tips': 'Советы по подготовке',
      'sat_tip_1': '1. Начинай минимум за 2–3 месяца. Регулярность важнее количества часов.',
      'sat_tip_2': '2. Делай официальные practice tests в Bluebook. Они максимально похожи на реальный экзамен.',
      'sat_tip_3': '3. Math: решай задачи на время. Тренируйся пользоваться калькулятором эффективно.',
      'sat_tip_4': '4. Reading & Writing: читай по 10–20 минут в день (The Economist, NYT, Scientific American).',
      'sat_tip_5': '5. Делай разбор ошибок после каждого теста. Не просто "прорешивай", а анализируй, где логика ломается.',
      'sat_tip_6': '6. Учи новые слова, но только высокочастотные. Не трать время на редкую лексику.',
      'sat_tip_7': '7. Во время экзамена не задерживайся на одном вопросе. SAT — адаптивный: важно держать ритм.',
      'sat_tip_8': '8. За 5–7 дней до экзамена сократи нагрузку. Пройди 1 финальный тест и отдыхай.',
      'sat_tip_9': '9. В день экзамена приходи заранее и заряди устройство. Digital SAT полностью проходит на ноутбуке.',
      // Calendar & Tasks
      ...
      'admin_task': 'Задача администратора',
      ...
      'overdue': 'Просрочено',
      // School Information
      'school_information': 'Школьный совет',
      'no_school_info': 'Нет школьной информации',
      'create_school_info': 'Создать школьную информацию',
      'category': 'Категория',
      'category_all': 'Все',
      'category_administration': 'Администрация',
      'category_ministry': 'Министерство',
      'category_rules': 'Правила',
      'category_announcement': 'Объявления',
      'pdf_url': 'URL PDF',
      ...
      'grade_suffix': 'класс',
      // Notification types
      'type_announcement': 'Объявление',
      'type_event': 'Событие',
      'type_alert': 'Предупреждение',
      ...
      'role_school_government': 'Школьный совет',
      // Example notifications
    ...
    'kk': {
      ...
      'kundelik_class_hint': 'Сынып Күнделік арқылы анықталады',
      'kundelik_class_connected': 'Сынып автоматты анықталады',
      ...
      'recommended_friends': 'Ұсынылатын достар',
      'use_search_to_find_friends': 'Достарды табу үшін іздеуді пайдаланыңыз',
      'refresh': 'Жаңарту',
      // Kundelik
      'kundelik': 'Күнделік',
      'sync_kundelik': 'Синхрондау',
      ...
      'manage_content_desc': 'Жаңалықтар мен хабарландыруларды жою',
      'delete_news': 'Жаңалықты жою',
      'delete_notification': 'Хабарландыруды жою',
      'confirm_delete': 'Мұны жойғыңыз келетініне сенімдісіз бе?',
      ...
      'sync_success': 'Сәтті синхрондалды',
      'kundelik_disconnect_confirm_title': 'Kundelik ажырату?',
      'kundelik_disconnect_confirm_message': 'ЖОК және туған күн деректері профильден жойылады.',
      'kundelik_session_expired': 'Сессия аяқталды. Kundelik-ты қайта қосыңыз.',
      'friend_request_sent': 'сізге дос болуға сұраныс жіберді',
      'birthday_notification_title': 'Туған күн!',
      'someone': 'Біреу',
      'marks_found': 'баға табылды',
      'no_marks_found': 'Бағалар табылмады — ЖОК қолжетімсіз',
      'kundelik_test': 'API тест',
      // Home Screen
      ...
      'calendar': 'Күнтізбе және тапсырмалар',
      // Functions Menu
      ...
      'create_news_desc': 'Оқушыларға жаңалықтар мен хабарландырулар жариялау',
      'create_notification': 'Хабарландыру жасау',
      'create_notification_desc': 'Барлық пайдаланушыларға хабарландырулар жіберу',
      'news_details': 'Жаңалық мәліметтері',
      'notification_details': 'Хабарландыру мәліметтері',
      'notification_type': 'Хабарландыру түрі',
      'title': 'Тақырып',
      'content': 'Мазмұны',
      'message': 'Хабарлама',
      'image_url': 'Сурет URL',
      ...
      // Olympiads
      'olympiads_calendar': 'Олимпиадалар күнтізбесі',
      'olympiads_desc': 'Олимпиадалар мен байқаулардың толық кестесін қарау',
      'open_olympiads_calendar': 'Күнтізбені ашу',
      'error_opening_link': 'Сілтемені ашу мүмкін болмады',
      // SAT
      'sat_preparation': 'SAT-қа дайындық',
      'sat_subtitle': 'Digital SAT ақпараты және ресурстары',
      'what_is_sat': 'SAT дегеніміз не?',
      'sat_description': 'SAT - АҚШ университеттеріне және Еуропа мен Азиядағы кейбір университеттерге түсу үшін қажет халықаралық емтихан. Қазір толығымен цифрлық (Digital SAT).\n\nЕмтихан екі бөліктен тұрады:\n• Оқу және жазу (64 минут, 54 сұрақ)\n• Математика (70 минут, 44 сұрақ)\n\nЖалпы ұзақтығы: шамамен 2 сағат 14 минут.',
      'scoring': 'Бағалау',
      'sat_scoring': 'Балл 400-ден 1600-ге дейін:\n• Оқу және жазу: 200–800\n• Математика: 200–800\n\nЖақсы балл:\n• Бәсекелестік: 1450+\n• Үздік университеттер: 1500+',
      'test_dates_2025': '2025 жылғы халықаралық емтихан күндері',
      'sat_dates': '• 8 наурыз\n• 3 мамыр\n• 7 маусым\n• 23 тамыз\n• 4 қазан\n• 8 қараша\n• 6 желтоқсан\n\nТіркеу әр емтихан күніне 3-4 апта бұрын жабылады.',
      'test_centers': 'Алматыдағы емтихан орталықтары',
      'sat_centers': '• Turan университеті (Туран)\n• Республикалық физика-математика мектебі (РФМШ)\n• «Мирас» халықаралық мектебі\n• Haileybury Almaty\n• Үздіксіз білім беру халықаралық колледжі (ICCE)\n• Назарбаев Зияткерлік мектептері (НЗМ)',
      'cost': 'Құны',
      'sat_cost': 'Халықаралық студенттер үшін шамамен \$103',
      'official_resources': 'Ресми ресурстар',
      'official_sat_website': 'SAT ресми сайты',
      'register_sat': 'SAT-қа тіркелу',
      'bluebook_app': 'Bluebook қосымшасы (тәжірибелік тесттер)',
      'khan_academy': 'Khan Academy (тегін дайындық)',
      'preparation_tips': 'Дайындық кеңестері',
      'sat_tip_1': '1. Кемінде 2-3 ай бұрын бастаңыз. Тұрақтылық сағаттардан маңызды.',
      'sat_tip_2': '2. Bluebook-та ресми тәжірибелік тесттерді тапсырыңыз. Олар нақты емтиханға ең ұқсас.',
      'sat_tip_3': '3. Математика: есептерді уақытында шешіңіз. Калькуляторды тиімді пайдалануды жаттықтырыңыз.',
      'sat_tip_4': '4. Оқу және жазу: күнде 10-20 минут оқыңыз (The Economist, NYT, Scientific American).',
      'sat_tip_5': '5. Әр тесттен кейін қателерді қарап шығыңыз. Тек "шешіңіз" ғана емес - логика қайда бұзылатынын талдаңыз.',
      'sat_tip_6': '6. Жаңа сөздерді үйреніңіз, бірақ тек жиі кездесетіндерін. Сирек кездесетін сөздерге уақыт жоғалтпаңыз.',
      'sat_tip_7': '7. Емтихан кезінде бір сұраққа көп уақыт бөлмеңіз. SAT бейімделгіш: қарқынды сақтаңыз.',
      'sat_tip_8': '8. Емтиханға 5-7 күн қалғанда жүктемені азайтыңыз. Соңғы бір тест тапсырып, демалыңыз.',
      'sat_tip_9': '9. Емтихан күні ерте келіңіз және құрылғыңызды зарядтаңыз. Digital SAT толығымен ноутбукта өтеді.',
      // Notifications & News
      ...
      'target_all': 'Барлық пайдаланушылар',
      'target_grade': 'Сынып',
      'target_class': 'Сынып',
      'target_user': 'Нақты пайдаланушы',
      'select_user': 'Пайдаланушыны таңдаңыз',
      'search_user': 'Пайдаланушыны іздеу',
      'grade_suffix': 'сынып',
      // Notification types
      'type_announcement': 'Хабарлама',
      'type_event': 'Оқиға',
      'type_alert': 'Ескерту',
      'type_info': 'Ақпарат',
      'notification_created': 'Хабарландыру сәтті жасалды',
      // News categories
      'news_created': 'Жаңалық сәтті жасалды',
      'category_general': 'Жалпы',
      'category_events': 'Оқиғалар',
      'category_academic': 'Оқу',
      'category_sports': 'Спорт',
      'category_clubs': 'Клубтар',
      'category_achievements': 'Жетістіктер',
      'category_important': 'Маңызды',
      // Links
      'links': 'Сілтемелер',
      'link_title': 'Сілтеме атауы',
      'link_title_hint': 'мысалы, Google Форма',
      'link_url': 'Сілтеме URL',
      'add_link': 'Сілтеме қосу',
      // Admin roles
      'role_admin': 'Әкімші',
      'role_moderator': 'Модератор',
      'role_teacher': 'Мұғалім',
      'role_school_government': 'Мектеп кеңесі',
      // Example notifications
      ...
      // Calendar & Tasks
      'no_tasks_for_day': 'Бұл күнде тапсырмалар жоқ',
      'add_task': 'Тапсырма қосу',
      'task_title': 'Тапсырма атауы',
      'deadline': 'Мерзім',
      'time_optional': 'Уақыт (міндетті емес)',
      'no_time_set': 'Уақыт орнатылмаған',
      'mark_complete': 'Орындалды деп белгілеу',
      'admin_task': 'Әкімші тапсырмасы',
      'personal_task': 'Жеке тапсырма',
      'created_by': 'Жасаған',
      'add': 'Қосу',
      'create': 'Жасау',
      'pending': 'Күтуде',
      ...
      // School Information
      'school_information': 'Мектеп кеңесі',
      'no_school_info': 'Мектеп ақпараты жоқ',
      'create_school_info': 'Мектеп ақпаратын жасау',
      'category': 'Санат',
      'category_all': 'Барлығы',
      'category_administration': 'Әкімшілік',
      'category_ministry': 'Министрлік',
      'category_rules': 'Ережелер',
      'category_announcement': 'Хабарландырулар',
      'pdf_url': 'PDF URL',
      ...
      'tasks': 'тапсырма',
      'at': 'сағат',
      'delete_task_confirmation': 'Бұл тапсырманы өшіргіңіз келетініне сенімдісіз бе?',
    },
  };
